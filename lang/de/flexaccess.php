...
$string['sa:locked'] = 'Eine andere Aktivierung läuft bereits. Bitte versuchen Sie es gleich erneut.';
$string['sa:notapplicable'] = 'Ihr Konto benötigt keine Aktivierung.';
$string['sa:nottemporary'] = 'Dieses Konto kann nicht aktiviert werden, da es kein aktives temporäres Konto ist.';
$string['sa:password'] = 'Passwort wählen';
